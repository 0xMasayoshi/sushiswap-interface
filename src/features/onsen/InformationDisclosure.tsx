      ...
      {({ open }) => (
        <>
          ...
          >
            <Disclosure.Panel
              static
              className="flex flex-col w-1/2 p-6 space-y-8 rounded rounded-t-none rounded-r-none min-w-min bg-dark-700"
            >
              <div className="flex items-center justify-between space-x-20 md:space-x-4">
